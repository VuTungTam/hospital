...
namespace Hospital.Application.Repositories.Interfaces.HealthFacilities
{
    ...
    {
        Task<PaginationResult<HealthFacility>> GetPagingWithFilterAsync(Pagination pagination, long facilityTypeId = 0, long serviceTypeId = 0, int pid = 0, HealthFacilityStatus status = HealthFacilityStatus.None, CancellationToken cancellationToken = default);
