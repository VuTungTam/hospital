...
namespace Hospital.Application.Dtos.Declarations
{
    public class DeclarationDto : BaseDto
    {
    ...
    public class DeclarationDtoValidator : BaseAbstractValidator<DeclarationDto>
    {
        public DeclarationDtoValidator(IStringLocalizer<Resources> localizer) : base(localizer)
        {
