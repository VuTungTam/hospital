...
{
    public class GetMyListBookingsPagingQueryHandler : BaseQueryHandler, IRequestHandler<GetMyListBookingsPagingQuery, PagingResult<BookingDto>>
    {
        ...
        public async Task<PagingResult<BookingDto>> Handle(GetMyListBookingsPagingQuery request, CancellationToken cancellationToken)
        {
            var paging = await _bookingReadRepository.GetMyListPagingWithFilterAsync(request.Pagination, request.Status, request.ServiceId, request.Date, cancellationToken);
