...
{
    public class GetMyListBookingsPagingQueryHandler : BaseQueryHandler, IRequestHandler<GetMyListBookingsPagingQuery, PagingResult<BookingResponseDto>>
    {
        ...
        public async Task<PagingResult<BookingResponseDto>> Handle(GetMyListBookingsPagingQuery request, CancellationToken cancellationToken)
        {
