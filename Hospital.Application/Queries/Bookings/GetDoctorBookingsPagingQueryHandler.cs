...
{
    public class GetDoctorBookingsPagingQueryHandler : BaseQueryHandler, IRequestHandler<GetDoctorBookingsPagingQuery, PaginationResult<BookingDto>>
    {
        ...
        public GetDoctorBookingsPagingQueryHandler(
        ...
        public async Task<PaginationResult<BookingDto>> Handle(GetDoctorBookingsPagingQuery request, CancellationToken cancellationToken)
        {
            var bookings = await _bookingReadRepository.GetDoctorPagingWithFilterAsync(request.Pagination, request.Status, request.ServiceId, request.TimeSlotId, request.Date, request.OwnerId, cancellationToken);
